              ...
              children: [
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.file(
                                image,
                                fit: BoxFit.cover,
                                errorBuilder: (_, __, ___) => Image.network(image.path,
                                  fit: BoxFit.cover,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                    Text("Categories",style: GoogleFonts.urbanist(
                    ...
                    StreamBuilder(
                      ...
                      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot<Map<String, dynamic>>> snapshot) {
                        if(snapshot.hasData) {
                          ...
                          List<Category> catoriesList = snapshot.data!.docs.map((e) => Category.fromMap(e.id,e.data())).toList();

                          if(assigneInitial == false){
                            assigneInitial = true;
                            if(!catoriesList.map((e) => e.name.toLowerCase()).toList().contains(category.value)) {
