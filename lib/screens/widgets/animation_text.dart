...
class AnimatedText extends StatelessWidget {
  const AnimatedText(this.text, {super.key, this.style, this.scaleAnimation, this.fadeAnimation, this.duration, this.flipAnimation, this.textAlign, this.typingAnimation, this.curve});
  final String text;
