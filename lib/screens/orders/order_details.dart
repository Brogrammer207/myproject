                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            modelOrderDetails.shipping.toString() == "0" ? "Free Shipping!" : "${modelOrderDetails.shipping.toString()} Rs",
                            style: TextStyle(
                                fontWeight: FontWeight.w500,
                                fontSize: 15,
                                color: modelOrderDetails.shipping.toString() == "0" ? Colors.greenAccent.shade700 : Colors.red),
                          ),
                        ],
                      ),
                      const SizedBox(
