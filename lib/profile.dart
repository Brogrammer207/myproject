                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: const DecorationImage(
                            fit: BoxFit.cover,
                            image: NetworkImage('https://cdn.pixabay.com/photo/2016/06/06/17/05/woman-1439909_1280.jpg')
                          )
                          ),
                    ),
                    Positioned(
    ...
    return  Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          IconButton(onPressed: (){}, icon: Icon(Icons.remove_red_eye,color: Colors.grey,)
          ) : null,
